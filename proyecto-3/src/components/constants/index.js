...
const track_lyris_get = 'track.lyrics.get?commontrack_id=';
const track_get = '';
...
export const trackLyricsGet = commontrack_id => `${cors_anywhere}${base_url}${track_lyris_get}${commontrack_id}${track_search_params}${api_key}`;
